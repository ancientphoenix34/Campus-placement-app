...
console.log(placementDetails);
    ...
    const registerplacementHandle = () => {
        if (!companyName ||
            ...
            axios.post(`${BACKEND_URL}placement/create`, placementDetails)
                .then((res) => {
                    if (res.data) {
                ...
                <div className="row">
                    <div className="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                        ...
                        <div className="col col-lg-7 ">
                            ...
                            className="btn btn-success ms-3 row CreatePlacementButton">Create placement</button>
                        </div>
                    </div>
                </div>
            </div>
